...
const permissionLabelArByKey: Record<PermissionKey, string> = {
  ...
  'signoffs.respond': 'الرد على الاعتمادات النهائية',
  'signoffs.remind': 'إرسال تذكير الاعتماد النهائي',
...
const permissionCatalogEntries = [
  ...
  { key: 'signoffs.respond', area: 'signoffs', labelEn: 'Respond to sign-offs' },
  { key: 'signoffs.remind', area: 'signoffs', labelEn: 'Send sign-off reminders' },
