...
CREATE INDEX "projects_workspace_client_org_idx" ON "projects" USING btree ("workspace_id","client_org_id");--> statement-breakpoint
ALTER TABLE "location_refs" ADD CONSTRAINT "location_refs_workspace_id_id_unique" UNIQUE("workspace_id","id");