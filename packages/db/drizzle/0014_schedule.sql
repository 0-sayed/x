...
ALTER TABLE "schedule_baselines" ADD CONSTRAINT "schedule_baselines_workspace_id_project_id_sign_off_id_sign_offs_workspace_id_project_id_id_fk" FOREIGN KEY ("workspace_id","project_id","sign_off_id") REFERENCES "public"."sign_offs"("workspace_id","project_id","id") ON DELETE SET NULL ("sign_off_id") ON UPDATE no action;--> statement-breakpoint
